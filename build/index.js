...
import { dbConection, defineMiddlewares, gracefulShutdown } from "./helpers/index.js";
// Create express app
var app = express();
...
server.on("listening", function() {
    console.log("Server up on: http://localhost:".concat(PORT, "/"));
});
...
function _startServer() {
    _startServer = _async_to_generator(function(PORT) {
        var db, error;
